package com.blockeng.framework.geetest;

import com.blockeng.framework.config.GeetestProperties;
...
public class GeetestLib {
    ...
    private String getFailPreProcessRes() {
        ...
        try {
            ...
            jsonObject.put("gt", this.geetestProperties.getCaptchaId());
            jsonObject.put("challenge", challenge);
            jsonObject.put("new_captcha", this.geetestProperties.isNewFailback());
    ...
    private int registerChallenge(HashMap<String, String> data) {
        ...
        try {
            ...
            String param = "gt=" + this.geetestProperties.getCaptchaId() + "&json_format=" + this.json_format;
            ...
            if (return_challenge.length() == 32) {
                ...
                this.responseStr = this.getSuccessPreProcessRes(this.md5Encode(return_challenge + this.geetestProperties.getPrivateKey()));
