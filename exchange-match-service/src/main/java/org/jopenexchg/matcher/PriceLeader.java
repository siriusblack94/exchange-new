...
public final class PriceLeader implements WithId {
    ...
    public BigDecimal score = BigDecimal.ZERO;  //优先级
    public BigDecimal price = BigDecimal.ZERO;        // 和排队列时候的值对应。考虑某些债券可能用收益率作为行情报价
    public BigDecimal over = BigDecimal.ZERO;    // 本价格档位上累计堆积了多少量. 累积量是0时价格档位马上回收
