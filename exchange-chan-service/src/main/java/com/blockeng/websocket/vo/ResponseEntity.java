package com.blockeng.websocket.vo;

import com.alibaba.fastjson.JSONObject;
import com.blockeng.websocket.ChannelServerConfig;
...
public class ResponseEntity {
    ...
    public WsResponse build() {
        ...
        return WsResponse.fromText(JSONObject.toJSONString(extend), ChannelServerConfig.CHARSET);
    }
